          ...
          {foreach from=$customizations.fields item="field"}
            <li class="product-customization-item">
              ...
              {if $field.type == 'text'}
                ...
                <textarea rows="10" cols="20" placeholder="{l s='Your message here' d='Shop.Forms.Help'}" class="product-message" maxlength="250" {if $field.required} required {/if} name="{$field.input_name}">
    {$product.description_short|strip_tags:false}</textarea>
