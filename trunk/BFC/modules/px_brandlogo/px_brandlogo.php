...
class Px_Brandlogo extends Module implements WidgetInterface
{
    protected $templateFile;

    public function __construct()
    {
        $this->name = 'px_brandlogo';
        ...
        $this->templateFile = 'module:px_brandlogo/views/templates/hook/px_brandlogo.tpl';
    }

    public function install()
    {
        Configuration::updateValue('PX_BRAND_SLIDER', 1);
        Configuration::updateValue('PX_BRAND_NAME', 0);
    ...
    public function uninstall()
    {
        return parent::uninstall()
            && Configuration::deleteByName('PX_BRAND_SLIDER')
            && Configuration::deleteByName('PX_BRAND_NAME');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitPxBlockBrandLogos')) {
            
			Configuration::updateValue('PX_BRAND_SLIDER', (int)(Tools::getValue('PX_BRAND_SLIDER')));
			Configuration::updateValue('PX_BRAND_NAME', (int)(Tools::getValue('PX_BRAND_NAME')));
			$this->_clearCache('*');
    ...
    public function renderForm()
    {
        ...
        $helper->submit_action = 'submitPxBlockBrandLogos';
    ...
    {
        return array(
            'PX_BRAND_SLIDER' => (int)Tools::getValue('PX_BRAND_SLIDER', Configuration::get('PX_BRAND_SLIDER')),
            'PX_BRAND_NAME' => (int)Tools::getValue('PX_BRAND_NAME', Configuration::get('PX_BRAND_NAME')),
        );
    }
    ...
    public function getWidgetVariables(
        ...
        return array(
            ...
            'slider' => Configuration::get('PX_BRAND_SLIDER'),
			'brandname' => Configuration::get('PX_BRAND_NAME'),
    ...
    public function renderWidget(
        ...
        $cacheId = $this->getCacheId('px_brandlogo');
