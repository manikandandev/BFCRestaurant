...
class AdminSmsProfile extends AdminController
{
    public $sms;
    ...
    {
        return "<link rel=\"stylesheet\" type=\"text/css\" href=\"../modules/prestasms/css/style.css\">" . "<div class=\"smsTab\">".$this->sms->display()."</div>";
    }
