...
class Px_NewProducts extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'px_newproducts';
        ...
        $this->templateFile = 'module:px_newproducts/views/templates/hook/px_newproducts.tpl';
    }
    ...
    public function install()
    {
        ...
        return parent::install()
            && Configuration::updateValue('PXNEW_PRODUCTS_NBR', 8)
			&& Configuration::updateValue('PXNEW_PRODUCTS_SLIDER', 0)
            && $this->registerHook('actionProductAdd')
            && $this->registerHook('actionProductUpdate')
            && $this->registerHook('actionProductDelete')
            && $this->registerHook('displayPxNew')
    ...
    public function uninstall()
    {
        ...
        if (!parent::uninstall() ||
            !Configuration::deleteByName('PXNEW_PRODUCTS_NBR')) {
            return false;
        }
    ...
    {
        $output = '';
        if (Tools::isSubmit('submitBlockPxNewProducts')) {

            $productNbr = Tools::getValue('PXNEW_PRODUCTS_NBR');
            ...
            if (!$productNbr || empty($productNbr)) {
                ...
                Configuration::updateValue('PXNEW_PRODUCTS_NBR', (int)$productNbr);
				Configuration::updateValue('PXNEW_PRODUCTS_SLIDER', (int)Tools::getValue('PXNEW_PRODUCTS_SLIDER'));
    ...
    public function renderForm()
    {
        ...
        $helper->submit_action = 'submitBlockPxNewProducts';
    ...
    public function getConfigFieldsValues()
    {
        return array(
            ...
            'PXNEW_PRODUCTS_NBR' => Tools::getValue('PXNEW_PRODUCTS_NBR', (int) Configuration::get('PXNEW_PRODUCTS_NBR')),
			'PXNEW_PRODUCTS_SLIDER' => Tools::getValue('PXNEW_PRODUCTS_SLIDER',(int)  Configuration::get('PXNEW_PRODUCTS_SLIDER')),
        );
    }

    public function renderWidget($hookName, array $configuration)
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('px_newproducts'))) {
        ...
        return $this->fetch($this->templateFile, $this->getCacheId('px_newproducts'));
    }
    ...
    public function getWidgetVariables($hookName, array $configuration)
    {
        ...
        if (!empty($products)) {
            return array(
				...
				'no_prod' => (int) Configuration::get('PXNEW_PRODUCTS_NBR'),
				'slider' => (int) Configuration::get('PXNEW_PRODUCTS_SLIDER'),
            );
        }
        return false;
    }
    ...
    protected function getNewProducts()
    {
        ...
        if (Configuration::get('PS_NB_DAYS_NEW_PRODUCT')) {
            $newProducts = Product::getNewProducts(
                ...
                0,
                (int)Configuration::get('PXNEW_PRODUCTS_NBR')
            );
        }
